...
class BackendContextBuilder:
    """Builds the context for the Backend Agent."""
    ...
    def build_context(self) -> dict[str, Any]:
        """Build the focused context dictionary for the Backend Agent."""
        ...
        return {
            ...
            "database": [d.model_dump() for d in blueprint.database],
