...
from aicli.providers.exceptions import ProviderConfigurationError
...
def build_default_provider_registry(settings: Settings | None = None) -> ProviderRegistry:
    ...
    from aicli.providers.anthropic import AnthropicProvider
    from aicli.providers.deepseek import DeepSeekProvider
    from aicli.providers.google import GoogleProvider
    from aicli.providers.openai import OpenAIProvider
    from aicli.providers.openrouter import OpenRouterProvider
