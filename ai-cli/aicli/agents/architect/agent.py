...
from aicli.agents.architect.context_builder import ArchitectContextBuilder
from aicli.agents.architect.models import ArchitectAgentResult
from aicli.agents.architect.prompts import (
    build_architect_system_prompt,
    build_architect_user_prompt,
)
from aicli.blueprint.evolution import evolve_blueprint
from aicli.blueprint.validation import validate_architecture_blueprint
...
from aicli.providers.exceptions import ProviderConfigurationError, ProviderRequestError
from aicli.providers.registry import ProviderRegistry, build_default_provider_registry
from aicli.schemas.blueprint import GoalDefinition, ProjectBlueprint
    ...
    def _create_provider(self) -> BaseProvider:
        ...
        if assignment is None or assignment.provider is None or assignment.model is None:
            msg = (
                ...
                "Use `aicli config --set architect=provider:model` first."
            )
