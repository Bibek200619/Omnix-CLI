...
from aicli.agents.master.memory_manager import detect_memory_updates
from aicli.agents.master.models import MasterAgentTurn
from aicli.agents.master.prompts import build_master_system_prompt
...
from aicli.schemas.memory import ConversationRole, GoalStatus, ProjectDecision, ProjectGoal
        ...
        *,
        ...
        if recorded_goal is not None:
            return (
                ...
                "`aicli config --set master=provider:model` for model-backed "
        ...
        return (
            ...
            "`aicli config --set master=provider:model` for model-backed discussion."
        )
